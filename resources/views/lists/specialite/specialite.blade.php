...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Spécialités</h1>
    </div>
    <div class="row">
        <form action="{{ route('list.specialite') }}" method="POST">
            @csrf
            @method('GET')
    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">List des spécialités</h6>
                @if ((Auth()->user()->type_user == '3') || (Auth()->user()->type_user == '1'))
                    <a href="{{ route('create.specialite') }}" class="btn btn-primary">Ajouter</a>
                @endif
            </div>
